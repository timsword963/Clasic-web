...
namespace HashElements\Modules\NewsModuleNine\Widgets;
...
class NewsModuleNine extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 9', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-nine he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'featured_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-big-post-item .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'listing_thumb_width', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-post-item .he-post-thumb' => 'width: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
            'featured_title_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-big-post-item .he-post-content h3' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'listing_title_color', [
                'label' => esc_html__('Listing Post Title Color', 'hash-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-post-item .he-post-content h3 a' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'listing_post_title_hover_color', [
                'label' => esc_html__('Listing Post Title Color (Hover)', 'hash-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-post-item .he-post-content h3 a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-nine .he-big-post-item .he-post-content h3',
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-nine .he-post-item .he-post-content h3',
            ]
        );
        ...
        $this->add_control(
            'featured_post_metas_color', [
                'label' => esc_html__('Featured Meta Color', 'hash-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-big-post-item .he-post-content .he-post-meta' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'listing_post_metas_color', [
                'label' => esc_html__('Listing Post Meta Color', 'hash-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-nine .he-post-item .he-post-content .he-post-meta' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-nine .he-big-post-item .he-post-content .he-post-meta, 
                           {{WRAPPER}} .he-news-module-nine .he-post-item .he-post-content .he-post-meta'
            ]
        );
                            ...
                            <div class="he-post-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    <div class="he-post-content">
                                        <h3 class="he-post-title"><?php the_title(); ?></h3>
    ...
    protected function render_header() {
        ...
        $nofollow = $settings['header_link']['nofollow'] ?
            ' rel="nofollow"' : '';
