...
namespace HashElements\Modules\NewsModuleTen\Widgets;
...
class NewsModuleTen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 10', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-ten he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_metas_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-ten .he-post-item .he-post-content .he-post-meta' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-ten  .he-post-item .he-post-content .he-post-meta',
            ]
        );
