    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-six ul.he-post-categories li a,
                           {{WRAPPER}} .he-news-module-six .post-content ul.he-post-categories li a',
            ]
        );
        ...
        $this->add_control(
            'top_block_title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-six .he-big-block .he-post-item .he-post-content h3.he-large-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
        ...
        $this->add_control(
            'bottom_block_title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-six .he-small-block .he-post-item .he-post-content h3' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
