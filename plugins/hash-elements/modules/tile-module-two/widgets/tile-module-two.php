...
namespace HashElements\Modules\TileModuleTwo\Widgets;
...
class TileModuleTwo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module Two', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-tile-module-two he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'module_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-tile-block.style2' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        <div class="he-tile-block-wrap">
            ...
            <div class="he-tile-block ht-clearfix style2 space-10">
                <?php
                ...
                while ($query->have_posts()):
                    ...
                    if ($index == 1) {
                        ...
                        if ($index == 2)
                            echo '<div class="he-width-50 he-height-100 he-parent he-right-col">';
                        ?>

                        <?php if ($index > 1) { ?>
                            <div class="he-height-50 he-width-50 he-thumb">
                                <div class="he-thumb-inner he-post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <?php
                                        if (has_post_thumbnail()) {
