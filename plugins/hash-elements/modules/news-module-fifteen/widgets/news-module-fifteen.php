...
namespace HashElements\Modules\NewsModuleFifteen\Widgets;
...
class NewsModuleFifteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 15', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-fifteen he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-mini-news .he-post-thumb .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-content h3 a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_hover_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-item h3 a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-post-content h3 a',
            ]
        );
        ...
        $this->add_control(
            'title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-post-item .he-post-content h3' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
