...
namespace HashElements\Modules\TileModuleThree\Widgets;
...
class TileModuleThree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module Three', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-tile-module-three he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'module_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-tile-block.style3' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
