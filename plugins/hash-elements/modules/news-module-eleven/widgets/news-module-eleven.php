...
namespace HashElements\Modules\NewsModuleEleven\Widgets;
...
class NewsModuleEleven extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 11', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-eleven he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-grid-block .he-post-thumb .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_hover_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-content h3:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-grid-blocks .he-post-content h3' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
