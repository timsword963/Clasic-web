...
namespace HashElements\Modules\NewsModuleFour\Widgets;
...
class NewsModuleFour extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 4', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-four he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'top_post_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item:nth-child(1) .he-thumb-container,
                     {{WRAPPER}} .he-news-module-four .he-post-item:nth-child(2) .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'bottom_post_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item:nth-child(3) .he-thumb-container,
                     {{WRAPPER}} .he-news-module-four .he-post-item:nth-child(4) .he-thumb-container, 
                     {{WRAPPER}} .he-news-module-four .he-post-item:nth-child(5) .he-thumb-container, 
                     {{WRAPPER}} .he-news-module-four .he-post-item:nth-child(6) .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'post_title_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-content h3, 
                     {{WRAPPER}} .he-news-module-four .he-post-item .he-post-content h3 a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'post_title_hover_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-content h3:hover, 
                     {{WRAPPER}} .he-news-module-four .he-post-item .he-post-content h3 a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-title.he-big-title'
            ]
        );
        ...
        $this->add_control(
            'top_post_title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-title.he-big-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-title:not(.he-big-title)',
            ]
        );
        ...
        $this->add_control(
            'bottom_post_title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-title:not(.he-big-title)' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
        ...
        $this->add_control(
            'post_metas_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-content .he-post-meta' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-news-module-four .he-post-item .he-post-content .he-post-meta'
            ]
        );
        ...
        <div class="he-news-module-four">
            ...
            <div class="he-news-module-four-wrap">
                ...
                while ($query->have_posts()):
                    ...
                    $title_class = ($index == 1 || $index == 2) ? 'he-big-title' : '';
                    ?>
