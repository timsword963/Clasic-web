...
namespace HashElements\Modules\NewsModuleThirteen\Widgets;
...
class NewsModuleThirteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 13', 'hash-elements');
    }

    /** Icon */
    public function get_icon() {
        return 'he-news-module-thirteen he-news-modules';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'post_thumb_height', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .he-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-content-wrap h3' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_hover_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-content-wrap h3 a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'hash-elements'),
                'selector' => '{{WRAPPER}} .he-post-content-wrap h3',
            ]
        );
        ...
        $this->add_control(
            'title_margin', [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .he-post-content-wrap h3' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        );
        ...
        $this->add_control(
            'content_bg_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .he-post-content' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div class="he-news-module-thirteen">
            <?php $this->render_header(); ?>

            <div class="he-alternate-block">
                <?php
                ...
                while ($query->have_posts()):
                    ...
                    ?>
                    <div class="he-alt-post-item he-post-item">
                        ...
                        <div class="he-post-content">
                            <div class="he-post-content-inner">
                                <div class="he-post-content-wrap">
                                    <div>
