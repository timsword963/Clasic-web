...
Source: https://stocksnap.io/photo/hotair-adventure-TBNDUDMYR3

About Us image
By: JESHOOTS.com
License: CC0 Public Domain 
Source: https://stocksnap.io/photo/floorplan-workshop-N3BPNPN0FY
...
= Version 1.4.0 =
* Fixed categories menu width
* Updated menu nav walker
* Added support for X social icon in the menu
* Tested with Elementor 3.22
* Tested with WooCommerce 9.0
* Tagged with WP 6.5

= Version 1.3.7 =
* Added new mobile menu styling
* Code improvements
* Tested with WooCommerce 8.5
* Tested with Elementor 3.19
* Tested with WP 6.4

= Version 1.3.6 =
* Fixed missing WooCommerce header cart content
* Fixed PHP 8.2 error
...
= Version 1.3.3 =
* Fixed categories menu open on mobile devices
* CSS improvements

= Version 1.3.2 =
* Fixed floating menu CSS
