...
<div class="wp-block wp-block-kubio-navigation  position-relative wp-block-kubio-navigation__outer <?php echo $component->printNavigationClasses(); ?> mistify-header__k__yzK-lx0we0j-outer mistify-local-598-outer h-navigation_overlap" data-kubio="kubio/navigation" data-kubio-component="overlap" data-kubio-settings="true" id="navigation">
	...
	<div class="wp-block wp-block-kubio-navigation-section  position-relative wp-block-kubio-navigation-section__nav mistify-header__k__u1zGN3yskOs-nav mistify-local-614-nav h-section h-navigation" data-kubio="kubio/navigation-section" data-kubio-component="navigation" data-kubio-settings="{&quot;sticky&quot;:{&quot;startAfterNode&quot;:{&quot;enabled&quot;:false},&quot;animations&quot;:{&quot;enabled&quot;:false,&quot;duration&quot;:0,&quot;name&quot;:&quot;slideDown&quot;}},&quot;overlap&quot;:true}">
		<div class="position-relative wp-block-kubio-navigation-section__nav-section mistify-header__k__u1zGN3yskOs-nav-section mistify-local-614-nav-section    <?php echo $component->printContainerClasses(); ?>">
							...
							<div class="position-relative wp-block-kubio-column__inner mistify-header__k__l73vKLrXSAA-inner mistify-local-617-inner d-flex h-flex-basis h-px-lg-3 v-inner-lg-0 h-px-md-3 v-inner-md-0 h-px-0 v-inner-0">
								<div class="position-relative wp-block-kubio-column__align mistify-header__k__l73vKLrXSAA-align mistify-local-617-align h-y-container h-column__content h-column__v-align flex-basis-auto align-self-lg-center align-self-md-center align-self-center">
									...
									mistify_theme()->get( 'logo' )->render(
										array(
											'wrapper_class'    => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row mistify-header__k__XPjHw7z7Xik-container mistify-local--container',
											'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  mistify-header__k__XPjHw7z7Xik-image mistify-local--image',
											'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   mistify-header__k__XPjHw7z7Xik-alternateImage mistify-local--alternateImage',
											'logo_text_class'  => 'position-relative wp-block-kubio-logo__text  mistify-header__k__XPjHw7z7Xik-text mistify-local--text',
										)
									);
									?>
								</div>
