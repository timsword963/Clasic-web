<div class="free-vs-pro-info-wrap">
    <div class="free-vs-pro-info">
        <h4><?php esc_html_e('ONE TIME PAYMENT', 'total'); ?></h4>
        <p><?php esc_html_e('No renewal needed', 'total'); ?></p>
    </div>

    <div class="free-vs-pro-info">
        <h4><?php esc_html_e('UNLIMITED DOMAIN LICENCE', 'total'); ?></h4>
        <p><?php esc_html_e('Use in as many websites as you need', 'total'); ?></p>
    </div>

    <div class="free-vs-pro-info">
        <h4><?php esc_html_e('FREE UPDATES FOR LIFETIME', 'total'); ?></h4>
        <p><?php esc_html_e('Keep up to date', 'total'); ?></p>
    </div>
</div>
...
<table class="comparison-table">
    <tr>
        <td>
            <span><?php esc_html_e('Upgrade to Pro', 'total'); ?></span>
            <p><?php esc_html_e('Upgrade to the pro version for additional features and better support.', 'total'); ?></p>
        </td>
        <td colspan="2">
            <a target="_blank" class="buy-pro-btn" href="https://hashthemes.com/wordpress-theme/total/?utm_source=wordpress&utm_medium=total-freevspro&utm_campaign=total-upgrade"><?php esc_html_e('Buy Now ($65 only)', 'total'); ?></a>
        </td>
    </tr>
    <tr>
        <th><?php esc_html_e('Features', 'total'); ?></th>
        <th><?php esc_html_e('Free', 'total'); ?></th>
        <th><?php esc_html_e('Pro', 'total'); ?></th>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li><a href="https://demo.hashthemes.com/total-plus/service-toggle-block/" target="_blank"><?php esc_html_e('Service Block - 4 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/el-portfolio-masonary/" target="_blank"><?php esc_html_e('Portfolio - 6 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/counter-block/" target="_blank"><?php esc_html_e('Counter - 4 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/team-block/" target="_blank"><?php esc_html_e('Team - 6 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/testimonial-block/" target="_blank"><?php esc_html_e('Testimonial - 4 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/pricing-block/" target="_blank"><?php esc_html_e('Pricing - 4 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/news-block/" target="_blank"><?php esc_html_e('News &amp; Update block - 3 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/tab-block/" target="_blank"><?php esc_html_e('Tabs - 5 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/blog-section/" target="_blank"><?php esc_html_e('Blog block - 4 styles', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/logo-carousel/" target="_blank"><?php esc_html_e('Client Logo - 4 styles', 'total'); ?></a></li>
            </ul>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li><a href="https://demo.hashthemes.com/total-plus/creative-agency/blog/" target="_blank"><?php esc_html_e('Blog Layout 2 Demo', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/construction/blog/" target="_blank"><?php esc_html_e('Blog Layout 3 Demo', 'total'); ?></a></li>
                <li><a href="https://demo.hashthemes.com/total-plus/one-page/blog/" target="_blank"><?php esc_html_e('Blog Layout 4 Demo', 'total'); ?></a></li>
            </ul>
        </td>
        <td>1</td>
        <td>4</td>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li><?php esc_html_e('iii) Essential Icon', 'total'); ?></li>
                <li><?php esc_html_e('iv) Material Icon', 'total'); ?></li>
            </ul>
        </td>
        <td><?php esc_html_e('Basic', 'total'); ?></td>
        <td><?php esc_html_e('Advanced', 'total'); ?></td>
    ...
    <tr>
        <td>
            <span><?php esc_html_e('37) RTL Ready', 'total'); ?></span>
            <p><?php esc_html_e('The Premium Version is fully compatible with RTL (Right to left) languages like Arabic', 'total'); ?></p>
        </td>
    ...
    <tr>
        <td>
            <span><?php esc_html_e('38) Multilingual Ready', 'total'); ?></span>
            <p><?php esc_html_e('The Premium Version is fully compatible with WPML and Poylang. Create the website in multiple languages.', 'total'); ?></p>
        </td>
        <td><?php esc_html_e('Partially', 'total'); ?></td>
        <td><?php esc_html_e('Fully', 'total'); ?></td>
    </tr>
    <tr>
        <td>
            <span><?php esc_html_e('39) Translation Ready', 'total'); ?></span>
            <p><?php esc_html_e('Both the free and pro versions are fully translation ready.', 'total'); ?>
        </td>
    ...
    <tr>
        <td>
            <span><?php esc_html_e('40) Search Engine Optimization', 'total'); ?></span>
            <p><?php esc_html_e('Follows best SEO practices so that your website always ranks higher in Search Engines.', 'total'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php esc_html_e('41) Major Browser Compatible', 'total'); ?></span>
            <p><?php esc_html_e('The website runs smoothly in all major browsers.', 'total'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php esc_html_e('42) Responsive - Mobile Friendly', 'total'); ?></span>
            <p><?php esc_html_e('Adapts to any screen size and displays beautifully.', 'total'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php esc_html_e('43) Fast and Friendly Support', 'total'); ?></span>
            <p><?php esc_html_e('For the Premium theme, the user will get a reply in 10 hours or less.', 'total'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        ...
        <td colspan="2">
            <a target="__blank" class="buy-pro-btn" href="https://hashthemes.com/wordpress-theme/total/?utm_source=wordpress&utm_medium=total-freevspro&utm_campaign=total-upgrade"><?php esc_html_e('Buy Now ($65 only)', 'total'); ?></a>
        </td>
    </tr>
</table>